...
function initMusic() { if (mainMusic || musicLoadFailed.main) return; try { mainMusic = new Audio("menu/main.mp3"); mainMusic.loop = true; mainMusic.volume = 0.4; mainMusic.onerror = () => { musicLoadFailed.main = true; mainMusic = null; }; } catch(e) { musicLoadFailed.main = true; } try { battleMusic = new Audio("menu/battle.mp3"); battleMusic.loop = true; battleMusic.volume = 0.4; battleMusic.onerror = () => { musicLoadFailed.battle = true; battleMusic = null; }; } catch(e) { musicLoadFailed.battle = true; } try { shopMusic = new Audio("menu/shop.mp3"); shopMusic.loop = true; shopMusic.volume = 0.4; shopMusic.onerror = () => { musicLoadFailed.shop = true; shopMusic = null; }; } catch(e) { musicLoadFailed.shop = true; } }
