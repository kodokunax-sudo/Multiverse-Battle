...
const customCardTemplates = {
    ...
    "Секретная": [
        ...
        { name: "Дэнди", universe: "Space Dandy", damage: 200, hp: 650, sellPrice: 2200, minRebirth: 3, ability: { type: "critChance", value: 0.15, desc: "+15% крит" }, statusAbility: { type: "shock", chance: 0.20, desc: "Шок 20%" }, desc: "Постоянный клиент космического фансервис-кафе " },
